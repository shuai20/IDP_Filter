#Timecost with blacklists size 100 200 400
...
def filter_sentences_and_measure_individual_times(idp_filter, sentences, category):
    """Filter sentences, measure processing time, and return cumulative times."""
    times_per_sentence = []
    filtered_sentences = []
    word_counts = []
    cumulative_time = 0
    ...
    for sentence in sentences:
        ...
        filtered_sentence, count = idp_filter.filter_text(sentence, "", "", "", [category])
        end_time = time.time()
...
def plot_cumulative_times(times_per_sentence_100, times_per_sentence_200, times_per_sentence_400, xlabel, ylabel, title, xlabel_fontsize=10, ylabel_fontsize=10):
...
def main():
    ...
    plot_cumulative_times(times_per_sentence_100, times_per_sentence_200, times_per_sentence_400,
                          ...
                          'Cumulative Filtering Time for Different Sizes of Blacklists')
